 ...
 * Do not call directly — use the \c MU_ASSERT macro.
 *
 * @param file  Source file name injected by the \c MU_ASSERT macro (__FILE__).
 * @param line  Source line number injected by the \c MU_ASSERT macro (__LINE__).
 ...
 * Do not call directly — use the \c MU_ASSERT_INT macro.
 *
 * @param file Source file name injected by \c MU_ASSERT_INT macro (__FILE__).
 * @param line Source line number injected by \c MU_ASSERT_INT macro (__LINE__).
 ...
 * Do not call directly — use the \c MU_ASSERT_STR macro.
 *
 * @param file Source file name injected by \c MU_ASSERT_STR macro (__FILE__).
 * @param line Source line number injected by \c MU_ASSERT_STR macro (__LINE__).
 ...
 * Do not call directly — use the \c MU_RUN macro.
 *
 ...
 *
 * Must be called as the last statement in `main()` via the \c MU_SUMMARY
